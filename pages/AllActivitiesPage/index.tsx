"use client"
import { border, Button, HStack, SimpleGrid, VStack, Text, Box, Menu, MenuButton, MenuList, RadioGroup, Stack, Radio, WrapItem, Wrap, Skeleton, SkeletonText } from "@chakra-ui/react"
          ...
          {isLoading
            ? Array.from({ length: 8 }).map((_, idx) => (
                <VStack key={idx} spacing={3} align="flex-start">
                  ...
                  <SkeletonText noOfLines={3} spacing={2} skeletonHeight={3} width="full" />
